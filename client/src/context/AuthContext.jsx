...
export const AuthProvider = ({ children }) => {
  ...
  const register = async (name, email, password, role, phone, college, profilePicture, addToExisting = false) => {
    const response = await axios.post('/api/auth/register', { name, email, password, role, phone, college, profilePicture })
    const newAccount = {
      token: response.data.token,
      user: response.data.user
    }
